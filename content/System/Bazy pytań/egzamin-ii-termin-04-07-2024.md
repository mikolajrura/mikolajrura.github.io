---
title: "Pytania — Egzamin II termin 4.07.2024"
tags:
  - farmakologia
  - pytania
  - egzamin
...
> Egzamin II termin 4.07.2024. W tej bazie (PDF) poprawne odpowiedzi były zaznaczone kolorem, który zniknął przy ekstrakcji. **Zaznacz sam:** w pliku zmień `-` na `+` przy poprawnej opcji (w Obsidianie), a quiz od razu zadziała.
...
```quiz
Wskaż zdanie nieprawidłowe o oleju rycynowym
...
```quiz
Denosumab - zaznacz przeciwwskazanie:
- niewydolność nerek
